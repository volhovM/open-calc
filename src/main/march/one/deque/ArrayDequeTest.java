...
public class ArrayDequeTest {
    ...
    private static void checkAssert() {
        ...
        if (!assertsEnabled) {
            throw new AssertionError(
                "You should enable assertions by running 'java -ea ArrayDequeTest'");
        }
    }
    ...
    private static void testFIFOOrder(Dequeue dequeue) {
        ...
        dequeue.addLast("a");
        dequeue.addLast("b");
        assertEquals(dequeue.removeFirst(),
                     "a",
                     "removeFirst must return elements in the order of addition (FIFO)");
        assertEquals(dequeue.removeFirst(),
                     "b",
                     "removeFirst must return elements in the order of addition (FIFO)");
    ...
    private static void testLIFOOrder(Dequeue dequeue) {
        ...
        assertEquals(dequeue.removeFirst(),
                     "b",
                     "removeFirst must return elements in the order of addition (LIFO)");
        assertEquals(dequeue.removeFirst(),
                     "a",
                     "removeFirst must return elements in the order of addition (LIFO)");
        assertTrue(dequeue.isEmpty(), "Dequeue should be empty");
    ...
    private static void testBackFIFOOrder(Dequeue dequeue) {
        ...
        dequeue.addFirst("a");
        dequeue.addFirst("b");
        assertEquals(dequeue.removeLast(),
                     "a",
                     "removeFirst must return elements in the order of addition (FIFO)");
        assertEquals(dequeue.removeLast(),
                     "b",
    ...
    private static void testSingleton(Dequeue dequeue) {
        ...
        assertEquals(dequeue.peekFirst(),
                     "a",
                     "peekFirst() for singleton removeFirst should return sole element");
        assertEquals(dequeue.peekLast(),
                     "a",
                     "peekLast() for singleton removeFirst should return sole element");
        assertEquals(dequeue.removeFirst(),
                     "a",
                     "removeFirst() for singleton removeFirst should return sole element");
        assertTrue(dequeue.isEmpty(), "Singleton removeFirst should be empty after removeFirst()");
        assertTrue(dequeue.size() == 0,
                   "Singleton removeFirst should have zero size after removeFirst");
    }
    ...
    private static void assertEquals(Object actual, Object expected, String message) {
        assertTrue(actual == null && expected == null || actual != null && actual.equals(expected),
