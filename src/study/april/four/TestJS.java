...
public class TestJS {
    ...
    public static void main(String[] args) throws ScriptException, IOException {
        ...
        engine.eval(new InputStreamReader(new FileInputStream("/home/volhovm/Dropbox/Code/Java/open-calc/src/study/april/four/eval.js"), "UTF-8"));
